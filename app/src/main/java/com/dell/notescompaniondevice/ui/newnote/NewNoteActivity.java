package com.dell.notescompaniondevice.ui.newnote;
...
public class NewNoteActivity extends AppCompatActivity implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        engine = NotesCompanionDeviceApplication.getEngine();
...
//                catch (Exception e)
//                {
//                    Toast.makeText(NewNoteActivity.this, "Failed to add image", Toast.LENGTH_LONG).show();
//                }
//            }
//        });
//
...
//                catch (Exception e)
//                {
//                    Toast.makeText(NewNoteActivity.this, "Failed to add block", Toast.LENGTH_LONG).show();
//                }
//            }
//        });
//
    ...
    private boolean displayContextMenu(final float x, final float y, final ContentBlock contentBlock_)
    {
        ...
        dialogBuilder.setItems(items.toArray(new String[items.size()]), new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                {
                    Toast.makeText(NewNoteActivity.this, "Operation failed : " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
                dialog.dismiss();
            }
        });
